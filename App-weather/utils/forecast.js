...
const forecast = (lattitude, longitude, location, callback)=>{
    ...
    request(optionObject, (error, res)=>{
        ...
        if(error){
            ...
            const currentWeather = `${current.weather_descriptions[0]} throughout the day. With a temperature of ${current.temperature} degrees. Humidity of ${current.humidity} and feels like ${current.feelslike}.`    
